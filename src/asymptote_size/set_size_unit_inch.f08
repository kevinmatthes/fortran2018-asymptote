...
!>
!> This subroutine will assign the unit `inch` (inches) to these size settings.
!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

pure subroutine set_size_unit_inch (this)
implicit none
    class (size), intent (inout)    :: this

    call conditional_free (this % unit)
    allocate (character (4) :: this % unit)
    this % unit = 'inch'
